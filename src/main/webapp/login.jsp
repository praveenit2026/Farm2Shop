...
<div class="login-wrapper">
    ...
    <div style="text-align: center; margin-bottom: 28px;">
        ...
        <p style="color: var(--text-secondary); font-size: 0.875rem; margin-top: 8px;">Sign in to your account</p>
    </div>
    ...
    <div class="form-container" style="margin: 0; max-width: 100%;">
        ...
        <p style="text-align: center; color: var(--text-secondary); font-size: 0.875rem;">
            ...
            <a href="${pageContext.request.contextPath}/register" style="color: var(--accent-green); font-weight: 700; margin-left: 4px;">Create one free</a>
        </p>
    </div>
