    ...
    <table>
        ...
        <tbody>
            <c:choose>
                        ...
                        <tr>
                            ...
                            <td>
                                <c:if test="${b.status != 'Rejected'}">
                                    <a href="${pageContext.request.contextPath}/farmer/track?bookingId=${b.id}"
                ...
                <c:otherwise>
                    <tr>
                        <td colspan="9" style="text-align: center; color: var(--text-secondary); padding: 30px;" data-i18n="farmer.noorders">No purchase orders received yet.</td>
                    </tr>
                </c:otherwise>
            </c:choose>
        </tbody>
